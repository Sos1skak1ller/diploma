#!/usr/bin/env python3
"""
Тестовый скрипт для проверки AI методов подавления шума
"""
...
from src.models.denoising_models import DenoisingModelManager, DnCNNModel
import cv2
import numpy as np
        ...
        for method in ai_methods:
            try:
                ...
                if enhanced_img is not None:
                    ...
                    # Сохраняем результат
                    output_path = f"test_output_{method}_{os.path.basename(image_path)}"

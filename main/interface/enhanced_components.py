"""
Улучшенные компоненты для интерфейса (drag & drop, расширенный просмотр и т.п.).
Перенесено из programm/enhanced_components.py.
"""
...
from PyQt5.QtGui import QPixmap, QWheelEvent, QMouseEvent, QFont, QPainter, QPen, QImage
...
class EnhancedGraphicsView(QGraphicsView):
    ...
    def set_image(self, image_path):
        ...
        # Используем OpenCV для стабильной загрузки без зависимости от Qt image plugins
...
class FileListWidget(QListWidget):
    ...
    def show_context_menu(self, position):
        """Показывает контекстное меню (можно расширить при необходимости)"""
